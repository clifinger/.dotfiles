...
let g:syntastic_filetype_map = { 'html.twig.js.css': 'twig' }
let g:syntastic_twig_twiglint_exe = '~/.config/composer/vendor/bin/twig-lint'
" Tagbar
...
nnoremap <silent> <C-l> :FixWhitespace<CR>
tnoremap <Esc> <C-\><C-n>
...
let g:startify_bookmarks = [
            \ {'j': '~/workspace/juloul/README.md'},
            \]
let g:project_use_nerdtree = 1
set rtp+=~/.config/nvim/plugged/vim-project
call project#rc("~/workspace")
Project  'juloul'
Callback 'juloul', 'Symfony'
